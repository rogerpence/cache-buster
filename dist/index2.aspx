...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/global.min.css?v=3esnvGusHBxz1KeNiRO9k">
    <link rel="stylesheet" href="./assets/css/main.css?v=6ytDvVpv8EBy-kXDNDtom">
</head>
    ...
    <div class="two-column-container">
        <div class="field-set-container left-side">
            ...
            <div class="field-set">
                ...
                <input class="w-lg" id="description" id="description" type="text"></divinput>
            </div>
            <div class="error-message-container">
                <span class="error-message-column-placeholder"></span>
                <div class="error-message">Error message</div>
